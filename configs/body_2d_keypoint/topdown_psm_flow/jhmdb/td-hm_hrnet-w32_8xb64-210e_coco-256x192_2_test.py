...
# codec settings
codec = dict(
    type='HeatMapPoseSegmentationMask', input_size=(256, 256), mask_size=(64, 64), dataset_type=dataset_type, sigma=3, use_flow=True)
...
# evaluators
val_evaluator = [
    dict(type='PSMHeatMapMetricWrapper', use_flow=True, save=True, metric_config=dict(type='JhmdbPCKAccuracy', thr=0.2, norm_item=['bbox', 'torso']), outfile_prefix='logs/jhmdb22_test/td-hm_res50_8xb64-20e_jhmdb-sub1-256x256'),
]
