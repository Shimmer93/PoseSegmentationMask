...
# evaluators
val_evaluator = [
    dict(type='PSMHeatMapMetricWrapper', use_flow=True, metric_config=dict(type='JhmdbPCKAccuracy', thr=0.2, norm_item=['bbox', 'torso']), outfile_prefix='logs/jhmdb22/td-hm_res50_8xb64-20e_jhmdb-sub1-256x256'),
]
