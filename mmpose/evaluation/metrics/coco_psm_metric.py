...
class CocoPSMMetric(BaseMetric):
    ...
    def process(self, data_batch: Sequence[dict],
        ...
        for data_sample in data_samples:
            ...
            if 'pred_fields' in data_sample:
                pred['masks'] = data_sample['pred_fields']['masks']
            ...
            if self.coco is None:
                ...
                gt['masks'] = data_sample['gt_fields']['masks']
            ...
            for instance in instances:
                if self.score_mode == 'bbox':
                    ...
                    raise NotImplementedError(
                        f'`score_mode` {self.score_mode} is not supported.')
            # perform nms
